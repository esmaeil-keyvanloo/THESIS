...
v5: input trips_v5_base.json (ALL fractions incl. glass).
Outputs: trips_v5_seg.json + segmentation_stats_v5.json
"""
import json, math
...
trips = json.load(open(f"{BASE}/W2/02_data_work/trips_v5_base.json", encoding="utf-8"))
...
json.dump(out, open(f"{BASE}/W2/02_data_work/trips_v5_seg.json", "w", encoding="utf-8"), separators=(",", ":"))
json.dump(stats, open(f"{BASE}/W2/02_data_work/segmentation_stats_v5.json", "w", encoding="utf-8"), indent=1)
