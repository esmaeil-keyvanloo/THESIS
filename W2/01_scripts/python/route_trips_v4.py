# Task C: route trips_v4 on road graph + depot/TS legs + dump-leg hypothesis test
import json, time
import numpy as np
...
TRIPS = ROOT + "/W2/02_data_work/trips_v4.json"
OUT_ROUTED = ROOT + "/W2/02_data_work/trips_routed_v4.json"
OUT_LEGS = ROOT + "/W2/02_data_work/depot_legs_v4.json"
OUT_ANAL = ROOT + "/W2/02_data_work/dumpleg_analysis.json"
