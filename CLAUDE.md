# Standing instructions — Sensor-based Recyclables Collection Planning (PhD, Rio Maior)

1. **Before any work: read `Brain/00_canon/project/PROJECT-STATE.md`** — the live session-state file (data map, chat log, open items). Do not start a task without it.
2. **At session close and after every major deliverable: update PROJECT-STATE.md** (prepend the session to the chat log, refresh data map and open items) **and write a digest** to `Brain/01_sources/sessions/YYYY-MM-DD-S<n>-<slug>.md`.
